...
runcmd:
  ...
  - [ bash, -c, 'wget -P /tmp https://raw.githubusercontent.com/bashfulrobot/libvirt-module/main/helpers/install-worker.sh >> /home/${var.admin_name}/cloud-init-run.log 2>&1' ]
