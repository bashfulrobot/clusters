...
runcmd:
  ...
  - [ bash, -c, 'wget -P /tmp https://raw.githubusercontent.com/bashfulrobot/libvirt-module/main/helpers/install-controller.sh >> /home/${var.admin_name}/cloud-init-run.log 2>&1' ]
  ...
  - [ bash, -c, 'wget -P /tmp https://raw.githubusercontent.com/bashfulrobot/libvirt-module/main/helpers/miniserve >> /home/${var.admin_name}/cloud-init-run.log 2>&1' ]
